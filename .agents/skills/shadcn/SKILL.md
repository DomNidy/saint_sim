...
Get current project context by executing: `npx shadcn@latest info --json`

The JSON will contain the project config and installed components. Use `npx shadcn@latest docs <component>` to get documentation and example URLs for any component.
