...
// # Gubulgi - Unholy - 2026-04-23 10:52 - US/Hydraxis
...
func TestBasic(t *testing.T) {
	...
	wowCharacter := api.WowCharacter{
		...
		EquippedItems: api.CharacterEquippedItems{
			MainHand: api.EquipmentItem{
				ItemId:    249671,
				EnchantId: ptr(3368),
				BonusIds:  &[]int{12786, 6652},
				Slot:      api.MainHand,
				GemIds:    &[]int{123, 9913, 1940, 19},
			},
		},
	}
	...
	s, err := equipmentRawline(wowCharacter.EquippedItems.MainHand)
	if err != nil {
		t.Fatal(err)
	}
